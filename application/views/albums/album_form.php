 <form class="form-horizontal" style="padding-left: 10%;  padding-right: 10%" enctype="multipart/form-data" action="" method="POST">
     ...
     <div class="form-group">
         <label class="col-sm-2 control-label " for="title">Judul Foto:</label>
         <div class="col-sm-6">
             <input type="text" class="form-control" placeholder="Masukan Judul Album" name="Title" id="Title" value="<?php echo isset($_POST['Title']) ? $_POST['Title'] : (isset($record->title) ? $record->title : ''); ?>">
         </div>
     </div>
     ...
     <noscript>
         <link rel="stylesheet" href="./application/third_party/Fileupload/css/jquery.fileupload-noscript.css">
     </noscript>
     <noscript>
         <link rel="stylesheet" href="./application/third_party/Fileupload/css/jquery.fileupload-ui-noscript.css">
     </noscript>

     <!-- The file upload form used as target for the file upload widget -->
     <fieldset id="fileupload" action="albums/do_upload" method="POST" enctype="multipart/form-data">
