                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="card card-success">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <?php echo form_open_multipart('admin/simpan_upload') ?>
                                <div class="form-group">
                                    <label for="email">Nama File:</label>
                                    <input type="text" class="form-control" name="user_id" value="<?= $user->id ?>" hidden>
                                    <input type="text" class="form-control" name="nama" placeholder="Masukan nama File" required>
                                </div>
                                <div class="form-group">
...
<script>
    $(document).ready(function() {
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url(); ?>admin/data_file",
            cache: false,
