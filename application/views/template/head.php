...
<head>
    ...
    <!-- overlayScrollbars -->
    <link rel="stylesheet" href="<?php echo base_url('assets/templates/plugins') ?>/overlayScrollbars/css/OverlayScrollbars.min.css">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="<?php echo base_url('assets/templates/plugins') ?>/daterangepicker/daterangepicker.css">
    <!-- summernote -->
    <link rel="stylesheet" href="<?php echo base_url('assets/templates/plugins') ?>/summernote/summernote-bs4.min.css">
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/templates/plugins') ?>/datatables-buttons/css/buttons.bootstrap4.min.css">
</head>
